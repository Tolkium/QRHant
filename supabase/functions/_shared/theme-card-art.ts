/** Keep in sync with src/app/core/themes/theme-card-art.ts — run: node scripts/port-theme-card-art.mjs */
...
function buildArtSvg(themeId: ThemeId, variant: number, locked: boolean): string {
